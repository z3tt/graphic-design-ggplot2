...
art of ***data visualization*** or ***information visualization***. Data
...
Data visualizations, or broadly speaking ***information graphics***, are
often classified as being either exploratory or explanatory.
***Exploratory graphics*** are generated to understand the data and
search for the relevant information. ***Explanatory graphics*** aim to
communicate the derived information between people
[@koponen&hilden2019]. In contrast to exploratory graphics, the creation
...
the most important question to me is the ***purpose*** of the graphic.
...
*pragmatic visualizations* [@kosara2007].
...
the precise, informative display of data[^introduction-1]. They
...
to elicit emotions and can be termed ***affective
graphics***[^introduction-2].

[^introduction-1]: However, I am not saying that these are the only ones
    that are great---there are definitely several magnificent pragmatic
    visualizations that come to my mind!

[^introduction-2]: Credit to the term **affective graphics** goes to
    Alberto Cairo, thank you for sharing your thoughts with me.

As a *creator*, clearly defining the purpose of a visualization helps to
make decisions about the data, the chart type, and the design. As a
*reader*, identifying the purpose helps rating the quality of the
...
present the data, we make decisions; and it is not about *if* we make
decisions but *which*. Chart types are not inherently 'right' or 'wrong'
...
> we design it---or before we critique it. [@cairo2021]
...
iterative process. Rarely[^introduction-3] the first draft is what ends
...
[^introduction-3]: I was very tempted to write "never" but I don't have
...
of. Furthermore, they come with several *extension libraries* (e.g.
...
benefits. The *reproducibility* of code makes the process more efficient
by being able to update the data or to use the code as a template for
future projects. The *transparency* of coded (and well-documented) data
workflows increases trust. The *scalability* of code allows to produce
...
analyze ecological data [@sciaini2018]. Consequently, I was *of course* 
...
* The layered approach of **ggplot2** opens the possibility to build any 
type of visualization.
* Various extension packages add missing functionality.
* Script-based workflows instead of *point–and–click* approaches allow for 
