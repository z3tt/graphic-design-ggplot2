...
By using a computational, code-driven approach we can combine all steps related to data visualization in the same environment: from the data import and cleaning to the precise and flexible encoding of quantitative information with custom designs. Programming languages such as JavaScript, Python, or R have a much steeper learning curve than chart builders but at the same time allow users to create almost any visualization one can think of. Furthermore, they come with several \emph{extension libraries} (e.g.~D3.js, echarts, Vega, Matplotlib, ggplot2) that provide additional approaches or add more opportunities to existing code.
...
\includegraphics{bookdown_files/figure-latex/06basicPlot-1.png}
...
\includegraphics{bookdown_files/figure-latex/unnamed-chunk-3-1.png}
...
\includegraphics{bookdown_files/figure-latex/06titleAlign-1.png}
...
\begin{figure}
\centering
\includegraphics{bookdown_files/figure-latex/06barsTitlePosition-1.png}
...
\includegraphics{bookdown_files/figure-latex/unnamed-chunk-7-1.png}
...
\includegraphics{bookdown_files/figure-latex/unnamed-chunk-9-1.png}
...
\includegraphics{bookdown_files/figure-latex/unnamed-chunk-9-2.png}
