...
\begin{figure}
\centering
\includegraphics{bookdown_files/figure-latex/02ggplotUniqueBabynamesBasic-1.png}
...
\begin{figure}
\centering
\includegraphics{bookdown_files/figure-latex/02ggplotUniqueBabynamesExplorative-1.png}
...
\begin{figure}
\centering
\includegraphics{bookdown_files/figure-latex/02ggplotUniqueBabynamesStorytelling-1.png}
...
\begin{figure}
\centering
\includegraphics{bookdown_files/figure-latex/04ggplotLocalAesthetics-1.png}
...
\NormalTok{  ) }\SpecialCharTok{+}
  \DocumentationTok{\#\# small multiples}
  \FunctionTok{facet\_grid}\NormalTok{(}
    \DocumentationTok{\#\# time of the day (rows) vs year (columns)}
...
\NormalTok{  ) }\SpecialCharTok{+}
  ...
  \FunctionTok{scale\_x\_continuous}\NormalTok{(}
    ...
    \AttributeTok{breaks =} \SpecialCharTok{{-}}\DecValTok{1}\SpecialCharTok{:}\DecValTok{6}\SpecialCharTok{*}\DecValTok{5}\CommentTok{\#, }
    \DocumentationTok{\#\# adjust axis padding}
    \CommentTok{\#expand = c(mult = 0, add = 1)}
\NormalTok{  ) }\SpecialCharTok{+}
  ...
  \FunctionTok{scale\_y\_continuous}\NormalTok{(}
    ...
    \AttributeTok{breaks =} \DecValTok{0}\SpecialCharTok{:}\DecValTok{5}\SpecialCharTok{*}\DecValTok{10000}\CommentTok{\#, }
    \DocumentationTok{\#\# adjust axis padding}
    \CommentTok{\#expand = c(mult = .1, add = 0)}
\NormalTok{  )}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  ) }\SpecialCharTok{+}
  \FunctionTok{scale\_x\_continuous}\NormalTok{(}
    \AttributeTok{breaks =} \SpecialCharTok{{-}}\DecValTok{1}\SpecialCharTok{:}\DecValTok{6}\SpecialCharTok{*}\DecValTok{5}\NormalTok{, }\AttributeTok{labels =} \ControlFlowTok{function}\NormalTok{(x) }\FunctionTok{paste0}\NormalTok{(x, }\StringTok{"°C"}\NormalTok{)}\CommentTok{\#, expand = c(mult = 0, add = 1)}
\NormalTok{  ) }\SpecialCharTok{+}
  \FunctionTok{scale\_y\_continuous}\NormalTok{(}
    \AttributeTok{breaks =} \DecValTok{0}\SpecialCharTok{:}\DecValTok{5}\SpecialCharTok{*}\DecValTok{10000}\NormalTok{, }\AttributeTok{labels =}\NormalTok{ scales}\SpecialCharTok{::}\FunctionTok{label\_comma}\NormalTok{()}\CommentTok{\#, expand = c(mult = .1, add = 0)}
\NormalTok{  ) }\SpecialCharTok{+}
...
Afterwards, we can perform the function for multiple subsets by iterating over a vector of categories (here seasons) with the help of the \textbf{\{purrr\}} package. Alternatively, you can use \texttt{lapply()} or a for loop to iterate over your filter conditions.
...
\begin{figure}
\centering
\includegraphics{bookdown_files/figure-latex/06workflowBatchSubsets-1.png}
...
\begin{figure}
\centering
\includegraphics{bookdown_files/figure-latex/06workflowBatchDataVar-1.png}
