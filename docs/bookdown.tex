...
\caption{\label{fig:unnamed-chunk-8}Two example use cases of the custom \texttt{plot\_density()} function applied to three variables of the \texttt{mpg} data (upper row) and the \texttt{bikes} data (lower row), respectively. For the latter, \texttt{day\_night} was passed as the grouping variable.}
\end{figure}
