...
\FunctionTok{ggplot}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{layer}\NormalTok{(}
    ...
    \AttributeTok{mapping =} \FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ temp, }\AttributeTok{y =}\NormalTok{ count),}
...
\begin{figure}
\centering
\includegraphics{bookdown_files/figure-latex/07layerPredefinedCustom-1.png}
...
\FunctionTok{ggplot}\NormalTok{(coins, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ date, }\AttributeTok{xend =}\NormalTok{ date, }
  ...
  \FunctionTok{geom\_segment}\NormalTok{(}
    \AttributeTok{arrow =} \FunctionTok{arrow}\NormalTok{(}\AttributeTok{type =} \StringTok{"closed"}\NormalTok{,}\AttributeTok{length =} \FunctionTok{unit}\NormalTok{(.}\DecValTok{4}\NormalTok{, }\StringTok{"lines"}\NormalTok{))}
\NormalTok{  )}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  bikes }\SpecialCharTok{\%\textgreater{}\%} 
  ...
  \FunctionTok{summarize}\NormalTok{(}\AttributeTok{avg =} \FunctionTok{mean}\NormalTok{(count), }\AttributeTok{sd =} \FunctionTok{sd}\NormalTok{(count))}

\FunctionTok{ggplot}\NormalTok{(bikes\_season, }
       \FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ season, }\AttributeTok{y =}\NormalTok{ avg, }\AttributeTok{ymin =}\NormalTok{ avg }\SpecialCharTok{{-}}\NormalTok{ sd, }\AttributeTok{ymax =}\NormalTok{ avg }\SpecialCharTok{+}\NormalTok{ sd)) }\SpecialCharTok{+}
...
\NormalTok{  ) }\SpecialCharTok{+}
  \FunctionTok{stat\_summary}\NormalTok{(}
    ...
    \AttributeTok{color =} \StringTok{"\#FF5477"}\NormalTok{,}
...
\texttt{\{r.\ include=FALSE\}\ ggplot(coins,\ aes(x\ =\ date,\ xend\ =\ date,\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ y\ =\ open,\ yend\ =\ close))\ +\ \ \ geom\_segment(\ \ \ \ \ \#\#\ encode\ segments\ by\ trend\ \ \ \ \ aes(color\ =\ close\ \textgreater{}\ open),\ \ \ \ \ \#\#\ draw\ arrow\ heads\ to\ indicate\ direction\ of\ change\ \ \ \ \ \ arrow\ =\ arrow(type\ =\ "closed",length\ =\ unit(.3,\ "lines"))\ \ \ )}
...
\NormalTok{p2 }\OtherTok{\textless{}{-}} 
  \FunctionTok{ggplot}\NormalTok{(bikes, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ temp)) }\SpecialCharTok{+}
  \FunctionTok{layer}\NormalTok{(}\AttributeTok{geom =} \StringTok{"bar"}\NormalTok{, }\AttributeTok{stat =} \StringTok{"bin"}\NormalTok{, }\AttributeTok{position =} \StringTok{"identity"}\NormalTok{)}

\NormalTok{p3 }\OtherTok{\textless{}{-}} 
  \FunctionTok{ggplot}\NormalTok{(bikes, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ wind\_speed, }\AttributeTok{y =}\NormalTok{ humidity)) }\SpecialCharTok{+}
  \FunctionTok{layer}\NormalTok{(}\AttributeTok{geom =} \StringTok{"smooth"}\NormalTok{, }\AttributeTok{stat =} \StringTok{"smooth"}\NormalTok{, }\AttributeTok{position =} \StringTok{"identity"}\NormalTok{, }\AttributeTok{params =} \FunctionTok{list}\NormalTok{(}\AttributeTok{se =} \ConstantTok{TRUE}\NormalTok{))}

\NormalTok{p1 }\SpecialCharTok{+} \FunctionTok{plot\_spacer}\NormalTok{() }\SpecialCharTok{+}\NormalTok{ p2 }\SpecialCharTok{+} \FunctionTok{plot\_spacer}\NormalTok{() }\SpecialCharTok{+}\NormalTok{ p3 }\SpecialCharTok{+} 
  \FunctionTok{plot\_layout}\NormalTok{(}\AttributeTok{nrow =} \DecValTok{1}\NormalTok{, }\AttributeTok{widths =} \FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{, .}\DecValTok{03}\NormalTok{, }\DecValTok{1}\NormalTok{, .}\DecValTok{03}\NormalTok{, }\DecValTok{1}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{bikes\_summerdays\_2015 }\OtherTok{\textless{}{-}}\NormalTok{ dplyr}\SpecialCharTok{::}\FunctionTok{filter}\NormalTok{(}
\NormalTok{  bikes, day\_night }\SpecialCharTok{==} \StringTok{"day"}\NormalTok{, year }\SpecialCharTok{==} \StringTok{"2015"}\NormalTok{, season }\SpecialCharTok{==} \StringTok{"summer"}
\NormalTok{)}

\FunctionTok{ggplot}\NormalTok{(bikes\_summerdays\_2015,}
       \FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ date, }\AttributeTok{xend =}\NormalTok{ date, }\DocumentationTok{\#\# start at previous temp}
           \AttributeTok{y =} \FunctionTok{lag}\NormalTok{(count), }\AttributeTok{yend =}\NormalTok{ count)) }\SpecialCharTok{+} \DocumentationTok{\#\# start at previous count}
  \FunctionTok{geom\_segment}\NormalTok{()}

\FunctionTok{ggplot}\NormalTok{(bikes\_summerdays\_2015,}
       \FunctionTok{aes}\NormalTok{(}\AttributeTok{x =} \FunctionTok{lag}\NormalTok{(date), }\AttributeTok{xend =}\NormalTok{ date, }\DocumentationTok{\#\# start at previous temp}
           \AttributeTok{y =} \FunctionTok{lag}\NormalTok{(count), }\AttributeTok{yend =}\NormalTok{ count)) }\SpecialCharTok{+} \DocumentationTok{\#\# start at previous count}
  \FunctionTok{geom\_segment}\NormalTok{(}
    \AttributeTok{alpha =}\NormalTok{ .}\DecValTok{5}\NormalTok{, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{color =}\NormalTok{ count }\SpecialCharTok{\textgreater{}} \FunctionTok{lag}\NormalTok{(count)), }
    \DocumentationTok{\#\# draw arrow heads to indicate direction of change }
    \AttributeTok{arrow =} \FunctionTok{arrow}\NormalTok{(}\AttributeTok{type =} \StringTok{"closed"}\NormalTok{,}\AttributeTok{length =} \FunctionTok{unit}\NormalTok{(.}\DecValTok{3}\NormalTok{, }\StringTok{"lines"}\NormalTok{))}
\NormalTok{  )}
\end{Highlighting}
\end{Shaded}
