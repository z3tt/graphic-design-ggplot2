...
```{r ggplot2-theme-gallery, echo=FALSE, warning = FALSE, fig.width=11, fig.height=7, fig.cap="An overview of all in-build themes that are contained in the **ggplot2** package."}
