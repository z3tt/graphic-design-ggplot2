                         ...
                         base_line_size = base_size/22, base_rect_size = base_size/22)
{
  theme_bw(base_size = base_size, base_family = base_family,
    ...
    theme(
      ...
      #axis.title.x = element_text(size = rel(1), face = "bold", color = "grey10", margin = margin(t = .3 * base_size)),
      # axis.title.y = element_text(size = rel(1), face = "bold", color = "grey10", angle = 90, margin = margin(r = .6 * base_size)),
      ...
      # legend.title = element_text(size = rel(1), face = "bold", color = "grey10", hjust = 0),
      # legend.margin = margin(c(0, 0, 0, 0)),
      # plot.tag = element_text(size = rel(1.25), color = "grey10"),
      # plot.title = element_text(size = rel(1.8), face = "bold", margin = margin(b = 1.25 * base_size)),
      # plot.subtitle = element_text(size = rel(1.2), margin = margin(t = -base_size, b = 1.25 * base_size)),
