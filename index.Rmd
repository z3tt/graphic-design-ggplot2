...
Package names are in bold text (e.g., **ggplot2**), and inline code and filenames are formatted in a typewriter font (e.g., `readr::read_csv('data.csv')`). Function names are followed by parentheses (e.g., `ggplot2::ggplot()`).
...
```{signature, type='flushright', html.tag='p'}
Cédric Scherer  
Berlin, Germany
```
