...
On a sunny day in July 2021, this tutorial served as the starting point for the book you hold in your hands. Plans changed a lot over the time and the book became something unique, that is loosely based on the tutorial and a 2-day workshop I was honored to teach at the rstudio::conf(2022) in Washington DC. In addition, I decided to include more advanced tips and insights in the process of creating custom, engaging data visualizations with **ggplot2**. I hope you enjoy it as much as I enjoyed learning and sharing **ggplot2** wizardry!
...
* The following R packages installed:
  ...
  + A set of other **tidyverse** packages:
    ...
    + [**lubridate**](https://lubriate.tidyverse.org/)
  ...
  + A few other packages providing useful functionality: 
    ...
    + [**ragg**](https://ragg.r-lib.org/) that includes [**systemfonts**](https://systemfonts.r-lib.org/)
...
install.packages(c(
  "ggplot2", "readr", "tibble", "dplyr", "tidyr", "forcats", "stringr", "lubridate", "ggforce", "ggtext", "colorspace", "scico", "rcartocolor", "patchwork", "magick", "ragg", "systemfonts", "sf"
))
```
